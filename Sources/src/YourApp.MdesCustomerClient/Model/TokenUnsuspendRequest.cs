...
namespace YourApp.MdesCustomerClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TokenUnsuspendRequest :  IEquatable<TokenUnsuspendRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenUnsuspendRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TokenUnsuspendRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenUnsuspendRequest" /> class.
        /// </summary>
        ...
        /// <param name="commentText">Comment related to unsuspension..</param>
        /// <param name="reasonCode">The reason for the action. Valid values:&lt;br /&gt;    \&quot;F\&quot; - Cardholder reported token device found or not stolen&lt;br /&gt;    \&quot;T\&quot; - Issuer or cardholder confirmed no fraudulent token transactions&lt;br /&gt;    \&quot;Z\&quot; - Other. (required).</param>
        /// <param name="auditInfo">auditInfo (required).</param>
        public TokenUnsuspendRequest(string tokenUniqueReference = default(string), string commentText = default(string), string reasonCode = default(string), AuditInfo auditInfo = default(AuditInfo))
        {
            // to ensure "tokenUniqueReference" is required (not null)
            if (tokenUniqueReference == null)
            {
                throw new InvalidDataException("tokenUniqueReference is a required property for TokenUnsuspendRequest and cannot be null");
            }
            else
            {
            ...
            if (reasonCode == null)
            {
                throw new InvalidDataException("reasonCode is a required property for TokenUnsuspendRequest and cannot be null");
            }
            else
            {
            ...
            if (auditInfo == null)
            {
                throw new InvalidDataException("auditInfo is a required property for TokenUnsuspendRequest and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Comment related to unsuspension.</value>
        ...
        /// </summary>
        /// <value>The reason for the action. Valid values:&lt;br /&gt;    \&quot;F\&quot; - Cardholder reported token device found or not stolen&lt;br /&gt;    \&quot;T\&quot; - Issuer or cardholder confirmed no fraudulent token transactions&lt;br /&gt;    \&quot;Z\&quot; - Other.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TokenUnsuspendRequest {\n");
        ...
        {
            return this.Equals(input as TokenUnsuspendRequest);
        }

        /// <summary>
        /// Returns true if TokenUnsuspendRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TokenUnsuspendRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TokenUnsuspendRequest input)
        {
            if (input == null)
                return false;
