...
namespace YourApp.MdesCustomerClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TokenResetMobilePinRequest :  IEquatable<TokenResetMobilePinRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenResetMobilePinRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TokenResetMobilePinRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenResetMobilePinRequest" /> class.
        /// </summary>
        ...
        /// <param name="reasonCode">The reason for the action. Valid values:&lt;br /&gt;    \&quot;N\&quot; - Cardholder requested new Mobile PIN&lt;br /&gt;    \&quot;R\&quot; – Mobile PIN try counter violation (required).</param>
        /// <param name="auditInfo">auditInfo (required).</param>
        public TokenResetMobilePinRequest(string tokenUniqueReference = default(string), string commentText = default(string), string reasonCode = default(string), AuditInfo auditInfo = default(AuditInfo))
        {
            // to ensure "tokenUniqueReference" is required (not null)
            if (tokenUniqueReference == null)
            {
                throw new InvalidDataException("tokenUniqueReference is a required property for TokenResetMobilePinRequest and cannot be null");
            }
            else
            {
            ...
            if (reasonCode == null)
            {
                throw new InvalidDataException("reasonCode is a required property for TokenResetMobilePinRequest and cannot be null");
            }
            else
            {
            ...
            if (auditInfo == null)
            {
                throw new InvalidDataException("auditInfo is a required property for TokenResetMobilePinRequest and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>The reason for the action. Valid values:&lt;br /&gt;    \&quot;N\&quot; - Cardholder requested new Mobile PIN&lt;br /&gt;    \&quot;R\&quot; – Mobile PIN try counter violation</value>
        ...
        {
            return this.Equals(input as TokenResetMobilePinRequest);
        }

        /// <summary>
        /// Returns true if TokenResetMobilePinRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TokenResetMobilePinRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TokenResetMobilePinRequest input)
        {
            if (input == null)
                return false;
