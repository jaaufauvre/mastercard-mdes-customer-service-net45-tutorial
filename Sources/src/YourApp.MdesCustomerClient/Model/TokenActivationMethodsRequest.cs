...
namespace YourApp.MdesCustomerClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TokenActivationMethodsRequest :  IEquatable<TokenActivationMethodsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenActivationMethodsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TokenActivationMethodsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenActivationMethodsRequest" /> class.
        /// </summary>
        ...
        public TokenActivationMethodsRequest(string tokenUniqueReference = default(string), AuditInfo auditInfo = default(AuditInfo))
        {
            // to ensure "tokenUniqueReference" is required (not null)
            if (tokenUniqueReference == null)
            {
                throw new InvalidDataException("tokenUniqueReference is a required property for TokenActivationMethodsRequest and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TokenActivationMethodsRequest {\n");
        ...
        {
            return this.Equals(input as TokenActivationMethodsRequest);
        }

        /// <summary>
        /// Returns true if TokenActivationMethodsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TokenActivationMethodsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TokenActivationMethodsRequest input)
        {
            if (input == null)
                return false;
