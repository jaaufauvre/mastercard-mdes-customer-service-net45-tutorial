...
namespace YourApp.MdesCustomerClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TokenSuspendRequest :  IEquatable<TokenSuspendRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenSuspendRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TokenSuspendRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenSuspendRequest" /> class.
        /// </summary>
        ...
        /// <param name="reasonCode">The reason for the action. Valid values:&lt;br /&gt;    \&quot;L\&quot; - Cardholder reported token device lost.&lt;br /&gt;    \&quot;S\&quot; - Cardholder reported token device stolen.&lt;br /&gt;    \&quot;T\&quot; - Issue or cardholder reported fraudulent token transactions.&lt;br /&gt;    \&quot;Z\&quot; - Other. (required).</param>
        /// <param name="auditInfo">auditInfo (required).</param>
        public TokenSuspendRequest(string tokenUniqueReference = default(string), string commentText = default(string), string reasonCode = default(string), AuditInfo auditInfo = default(AuditInfo))
        {
            // to ensure "tokenUniqueReference" is required (not null)
            if (tokenUniqueReference == null)
            {
                throw new InvalidDataException("tokenUniqueReference is a required property for TokenSuspendRequest and cannot be null");
            }
            else
            {
            ...
            if (reasonCode == null)
            {
                throw new InvalidDataException("reasonCode is a required property for TokenSuspendRequest and cannot be null");
            }
            else
            {
            ...
            if (auditInfo == null)
            {
                throw new InvalidDataException("auditInfo is a required property for TokenSuspendRequest and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>The reason for the action. Valid values:&lt;br /&gt;    \&quot;L\&quot; - Cardholder reported token device lost.&lt;br /&gt;    \&quot;S\&quot; - Cardholder reported token device stolen.&lt;br /&gt;    \&quot;T\&quot; - Issue or cardholder reported fraudulent token transactions.&lt;br /&gt;    \&quot;Z\&quot; - Other.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TokenSuspendRequest {\n");
        ...
        {
            return this.Equals(input as TokenSuspendRequest);
        }

        /// <summary>
        /// Returns true if TokenSuspendRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TokenSuspendRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TokenSuspendRequest input)
        {
            if (input == null)
                return false;
