...
namespace YourApp.MdesCustomerClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TokenCommentsRequest :  IEquatable<TokenCommentsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenCommentsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TokenCommentsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenCommentsRequest" /> class.
        /// </summary>
        ...
        public TokenCommentsRequest(string tokenUniqueReference = default(string), AuditInfo auditInfo = default(AuditInfo))
        {
            // to ensure "tokenUniqueReference" is required (not null)
            if (tokenUniqueReference == null)
            {
                throw new InvalidDataException("tokenUniqueReference is a required property for TokenCommentsRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TokenCommentsRequest);
        }

        /// <summary>
        /// Returns true if TokenCommentsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TokenCommentsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TokenCommentsRequest input)
        {
            if (input == null)
                return false;
