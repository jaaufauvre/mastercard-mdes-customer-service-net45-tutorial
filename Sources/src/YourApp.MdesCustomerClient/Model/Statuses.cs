...
namespace YourApp.MdesCustomerClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Statuses :  IEquatable<Statuses>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Statuses" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        public Statuses(List<Status> status = default(List<Status>))
        {
            this.Status = status;
        }
        ...
        {
            return this.Equals(input as Statuses);
        }

        /// <summary>
        /// Returns true if Statuses instances are equal
        /// </summary>
        /// <param name="input">Instance of Statuses to be compared</param>
        /// <returns>Boolean</returns>
